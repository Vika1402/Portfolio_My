...
const MernStackIcons = () => {
  return (
    <div className="flex flex-wrap items-center justify-center mt-16 text-center p-auto gap-10 p-1">
      ...
      <div className="icon-item flex items-center">
        <FaNodeJs className="text-4xl   lg:text-5xl flex  items-center  text-green-500" />
